...
jQuery(document).ready(function($) {
    ...
    $('body').on('change', '.pickle-calendar-filters .filter-term', function() {
        ...
        // apply fliters here //
        $('.pickle-calendar .pickle-calendar-event').each(function() {
    ...
    $.fn.pcEventOffset = function() {
        ...
        if (typeof prevEvent.offset() !== 'undefined' && prevEvent.offset().top !== thisOffset.top) {
            ...
            if (prevEvent.offset().top !== jQuery(this).offset().top) {
                jQuery(this).css({
                    'margin-top': parseInt(jQuery(this).css('margin-top'), 10) + (prevEvent.offset().top - jQuery(this).offset().top)
                });
            }
        }
