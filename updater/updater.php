...
if ( ! defined( 'ABSPATH' ) || class_exists( 'Pickle_Calender_GitHub_Updater' ) )
	return;
 ...
 */
//class WP_GitHub_Updater { // renamed for plugin
class Pickle_Calender_GitHub_Updater {
	...
	public function overrule_transients() {
		return ( defined( 'PICKLE_CALENDAR_GITHUB_FORCE_UPDATE' ) && PICKLE_CALENDAR_GITHUB_FORCE_UPDATE );
	}
